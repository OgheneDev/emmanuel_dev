          ...
          >
            {projects.map((project, index) => (
              <motion.div
                ...
                className="group"
              >
                <Card className="overflow-hidden cursor-pointer bg-gray-800/50 backdrop-blur-sm border-gray-700 hover:border-blue-500/20 transition-all duration-300 hover:shadow-xl hover:shadow-blue-500/10">
                  <motion.div 
